...
In previous examples, the spiral is always drawn in the center of the image, which results in that there are large white area
in the right part of the image. See the following image which is the same as the previous one but I additionally add border of the image and border of the spiral viewport.
...
Actually the position of the spiral viewport can be controlled with argument `vp_param` which is a list of parameters and will
be sent to the function `viewport()` that contruct teh spiral viewport. E.g. to move the spiral viewport to the most left of the image:
